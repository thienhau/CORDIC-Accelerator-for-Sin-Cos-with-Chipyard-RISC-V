...
$(addprefix $(output_dir)/, $(addsuffix .hex, $(rv64uzbs-p-asm-tests))): $(output_dir)/%.hex: $(RISCV)/riscv64-unknown-elf/share/riscv-tests/isa/%.hex
	mkdir -p $(output_dir)
	ln -fs $< $@

$(addprefix $(output_dir)/, $(rv64uzbs-p-asm-tests)): $(output_dir)/%: $(RISCV)/riscv64-unknown-elf/share/riscv-tests/isa/%
	mkdir -p $(output_dir)
	ln -fs $< $@

run-rv64uzbs-p-asm-tests: $(addprefix $(output_dir)/, $(addsuffix .out, $(rv64uzbs-p-asm-tests)))
	@echo; perl -ne 'print "  [$$1] $$ARGV \t$$2\n" if( /\*{3}(.{8})\*{3}(.*)/ || /ASSERTION (FAILED):(.*)/i )' $^ /dev/null | perl -pe 'BEGIN { $$failed = 0 } $$failed = 1 if(/FAILED/i); END { exit($$failed) }'

run-rv64uzbs-p-asm-tests-debug: $(addprefix $(output_dir)/, $(addsuffix .vpd, $(rv64uzbs-p-asm-tests)))
	@echo; perl -ne 'print "  [$$1] $$ARGV \t$$2\n" if( /\*{3}(.{8})\*{3}(.*)/ || /ASSERTION (FAILED):(.*)/i )' $(patsubst %.vpd,%.out,$^) /dev/null | perl -pe 'BEGIN { $$failed = 0 } $$failed = 1 if(/FAILED/i); END { exit($$failed) }'

run-rv64uzbs-p-asm-tests-fst: $(addprefix $(output_dir)/, $(addsuffix .fst, $(rv64uzbs-p-asm-tests)))
	@echo; perl -ne 'print "  [$$1] $$ARGV \t$$2\n" if( /\*{3}(.{8})\*{3}(.*)/ || /ASSERTION (FAILED):(.*)/i )' $(patsubst %.fst,%.out,$^) /dev/null | perl -pe 'BEGIN { $$failed = 0 } $$failed = 1 if(/FAILED/i); END { exit($$failed) }'

rv64uzba-p-asm-tests = \
	rv64uzba-p-sh1add \
	rv64uzba-p-sh2add \
	rv64uzba-p-sh3add \
...
$(addprefix $(output_dir)/, $(addsuffix .hex, $(rv64uzba-p-asm-tests))): $(output_dir)/%.hex: $(RISCV)/riscv64-unknown-elf/share/riscv-tests/isa/%.hex
	mkdir -p $(output_dir)
	ln -fs $< $@

$(addprefix $(output_dir)/, $(rv64uzba-p-asm-tests)): $(output_dir)/%: $(RISCV)/riscv64-unknown-elf/share/riscv-tests/isa/%
	mkdir -p $(output_dir)
	ln -fs $< $@

run-rv64uzba-p-asm-tests: $(addprefix $(output_dir)/, $(addsuffix .out, $(rv64uzba-p-asm-tests)))
	@echo; perl -ne 'print "  [$$1] $$ARGV \t$$2\n" if( /\*{3}(.{8})\*{3}(.*)/ || /ASSERTION (FAILED):(.*)/i )' $^ /dev/null | perl -pe 'BEGIN { $$failed = 0 } $$failed = 1 if(/FAILED/i); END { exit($$failed) }'

run-rv64uzba-p-asm-tests-debug: $(addprefix $(output_dir)/, $(addsuffix .vpd, $(rv64uzba-p-asm-tests)))
	@echo; perl -ne 'print "  [$$1] $$ARGV \t$$2\n" if( /\*{3}(.{8})\*{3}(.*)/ || /ASSERTION (FAILED):(.*)/i )' $(patsubst %.vpd,%.out,$^) /dev/null | perl -pe 'BEGIN { $$failed = 0 } $$failed = 1 if(/FAILED/i); END { exit($$failed) }'

run-rv64uzba-p-asm-tests-fst: $(addprefix $(output_dir)/, $(addsuffix .fst, $(rv64uzba-p-asm-tests)))
	@echo; perl -ne 'print "  [$$1] $$ARGV \t$$2\n" if( /\*{3}(.{8})\*{3}(.*)/ || /ASSERTION (FAILED):(.*)/i )' $(patsubst %.fst,%.out,$^) /dev/null | perl -pe 'BEGIN { $$failed = 0 } $$failed = 1 if(/FAILED/i); END { exit($$failed) }'
...
rv64uzba-v-asm-tests = \
	rv64uzba-v-sh1add \
	rv64uzba-v-sh2add \
	rv64uzba-v-sh3add \
	rv64uzba-v-sh1add_uw \
	rv64uzba-v-sh2add_uw \
	rv64uzba-v-sh3add_uw \
	rv64uzba-v-add_uw \
	rv64uzba-v-slli_uw

$(addprefix $(output_dir)/, $(addsuffix .hex, $(rv64uzba-v-asm-tests))): $(output_dir)/%.hex: $(RISCV)/riscv64-unknown-elf/share/riscv-tests/isa/%.hex
	mkdir -p $(output_dir)
	ln -fs $< $@

$(addprefix $(output_dir)/, $(rv64uzba-v-asm-tests)): $(output_dir)/%: $(RISCV)/riscv64-unknown-elf/share/riscv-tests/isa/%
	mkdir -p $(output_dir)
	ln -fs $< $@

run-rv64uzba-v-asm-tests: $(addprefix $(output_dir)/, $(addsuffix .out, $(rv64uzba-v-asm-tests)))
	@echo; perl -ne 'print "  [$$1] $$ARGV \t$$2\n" if( /\*{3}(.{8})\*{3}(.*)/ || /ASSERTION (FAILED):(.*)/i )' $^ /dev/null | perl -pe 'BEGIN { $$failed = 0 } $$failed = 1 if(/FAILED/i); END { exit($$failed) }'

run-rv64uzba-v-asm-tests-debug: $(addprefix $(output_dir)/, $(addsuffix .vpd, $(rv64uzba-v-asm-tests)))
	@echo; perl -ne 'print "  [$$1] $$ARGV \t$$2\n" if( /\*{3}(.{8})\*{3}(.*)/ || /ASSERTION (FAILED):(.*)/i )' $(patsubst %.vpd,%.out,$^) /dev/null | perl -pe 'BEGIN { $$failed = 0 } $$failed = 1 if(/FAILED/i); END { exit($$failed) }'

run-rv64uzba-v-asm-tests-fst: $(addprefix $(output_dir)/, $(addsuffix .fst, $(rv64uzba-v-asm-tests)))
	@echo; perl -ne 'print "  [$$1] $$ARGV \t$$2\n" if( /\*{3}(.{8})\*{3}(.*)/ || /ASSERTION (FAILED):(.*)/i )' $(patsubst %.fst,%.out,$^) /dev/null | perl -pe 'BEGIN { $$failed = 0 } $$failed = 1 if(/FAILED/i); END { exit($$failed) }'

rv64uzbs-v-asm-tests = \
	rv64uzbs-v-bclr \
	rv64uzbs-v-bclri \
	rv64uzbs-v-bext \
	rv64uzbs-v-bexti \
...
$(addprefix $(output_dir)/, $(addsuffix .hex, $(rv64uzbs-v-asm-tests))): $(output_dir)/%.hex: $(RISCV)/riscv64-unknown-elf/share/riscv-tests/isa/%.hex
	mkdir -p $(output_dir)
	ln -fs $< $@

$(addprefix $(output_dir)/, $(rv64uzbs-v-asm-tests)): $(output_dir)/%: $(RISCV)/riscv64-unknown-elf/share/riscv-tests/isa/%
	mkdir -p $(output_dir)
	ln -fs $< $@

run-rv64uzbs-v-asm-tests: $(addprefix $(output_dir)/, $(addsuffix .out, $(rv64uzbs-v-asm-tests)))
	@echo; perl -ne 'print "  [$$1] $$ARGV \t$$2\n" if( /\*{3}(.{8})\*{3}(.*)/ || /ASSERTION (FAILED):(.*)/i )' $^ /dev/null | perl -pe 'BEGIN { $$failed = 0 } $$failed = 1 if(/FAILED/i); END { exit($$failed) }'

run-rv64uzbs-v-asm-tests-debug: $(addprefix $(output_dir)/, $(addsuffix .vpd, $(rv64uzbs-v-asm-tests)))
	@echo; perl -ne 'print "  [$$1] $$ARGV \t$$2\n" if( /\*{3}(.{8})\*{3}(.*)/ || /ASSERTION (FAILED):(.*)/i )' $(patsubst %.vpd,%.out,$^) /dev/null | perl -pe 'BEGIN { $$failed = 0 } $$failed = 1 if(/FAILED/i); END { exit($$failed) }'

run-rv64uzbs-v-asm-tests-fst: $(addprefix $(output_dir)/, $(addsuffix .fst, $(rv64uzbs-v-asm-tests)))
	@echo; perl -ne 'print "  [$$1] $$ARGV \t$$2\n" if( /\*{3}(.{8})\*{3}(.*)/ || /ASSERTION (FAILED):(.*)/i )' $(patsubst %.fst,%.out,$^) /dev/null | perl -pe 'BEGIN { $$failed = 0 } $$failed = 1 if(/FAILED/i); END { exit($$failed) }'
...
$(addprefix $(output_dir)/, $(addsuffix .hex, $(rv64uzbb-v-asm-tests))): $(output_dir)/%.hex: $(RISCV)/riscv64-unknown-elf/share/riscv-tests/isa/%.hex
	mkdir -p $(output_dir)
	ln -fs $< $@

$(addprefix $(output_dir)/, $(rv64uzbb-v-asm-tests)): $(output_dir)/%: $(RISCV)/riscv64-unknown-elf/share/riscv-tests/isa/%
	mkdir -p $(output_dir)
	ln -fs $< $@

run-rv64uzbb-v-asm-tests: $(addprefix $(output_dir)/, $(addsuffix .out, $(rv64uzbb-v-asm-tests)))
	@echo; perl -ne 'print "  [$$1] $$ARGV \t$$2\n" if( /\*{3}(.{8})\*{3}(.*)/ || /ASSERTION (FAILED):(.*)/i )' $^ /dev/null | perl -pe 'BEGIN { $$failed = 0 } $$failed = 1 if(/FAILED/i); END { exit($$failed) }'

run-rv64uzbb-v-asm-tests-debug: $(addprefix $(output_dir)/, $(addsuffix .vpd, $(rv64uzbb-v-asm-tests)))
	@echo; perl -ne 'print "  [$$1] $$ARGV \t$$2\n" if( /\*{3}(.{8})\*{3}(.*)/ || /ASSERTION (FAILED):(.*)/i )' $(patsubst %.vpd,%.out,$^) /dev/null | perl -pe 'BEGIN { $$failed = 0 } $$failed = 1 if(/FAILED/i); END { exit($$failed) }'

run-rv64uzbb-v-asm-tests-fst: $(addprefix $(output_dir)/, $(addsuffix .fst, $(rv64uzbb-v-asm-tests)))
	@echo; perl -ne 'print "  [$$1] $$ARGV \t$$2\n" if( /\*{3}(.{8})\*{3}(.*)/ || /ASSERTION (FAILED):(.*)/i )' $(patsubst %.fst,%.out,$^) /dev/null | perl -pe 'BEGIN { $$failed = 0 } $$failed = 1 if(/FAILED/i); END { exit($$failed) }'
...
$(addprefix $(output_dir)/, $(addsuffix .hex, $(rv64uzfh-v-asm-tests))): $(output_dir)/%.hex: $(RISCV)/riscv64-unknown-elf/share/riscv-tests/isa/%.hex
	mkdir -p $(output_dir)
	ln -fs $< $@

$(addprefix $(output_dir)/, $(rv64uzfh-v-asm-tests)): $(output_dir)/%: $(RISCV)/riscv64-unknown-elf/share/riscv-tests/isa/%
	mkdir -p $(output_dir)
	ln -fs $< $@

run-rv64uzfh-v-asm-tests: $(addprefix $(output_dir)/, $(addsuffix .out, $(rv64uzfh-v-asm-tests)))
	@echo; perl -ne 'print "  [$$1] $$ARGV \t$$2\n" if( /\*{3}(.{8})\*{3}(.*)/ || /ASSERTION (FAILED):(.*)/i )' $^ /dev/null | perl -pe 'BEGIN { $$failed = 0 } $$failed = 1 if(/FAILED/i); END { exit($$failed) }'

run-rv64uzfh-v-asm-tests-debug: $(addprefix $(output_dir)/, $(addsuffix .vpd, $(rv64uzfh-v-asm-tests)))
	@echo; perl -ne 'print "  [$$1] $$ARGV \t$$2\n" if( /\*{3}(.{8})\*{3}(.*)/ || /ASSERTION (FAILED):(.*)/i )' $(patsubst %.vpd,%.out,$^) /dev/null | perl -pe 'BEGIN { $$failed = 0 } $$failed = 1 if(/FAILED/i); END { exit($$failed) }'

run-rv64uzfh-v-asm-tests-fst: $(addprefix $(output_dir)/, $(addsuffix .fst, $(rv64uzfh-v-asm-tests)))
	@echo; perl -ne 'print "  [$$1] $$ARGV \t$$2\n" if( /\*{3}(.{8})\*{3}(.*)/ || /ASSERTION (FAILED):(.*)/i )' $(patsubst %.fst,%.out,$^) /dev/null | perl -pe 'BEGIN { $$failed = 0 } $$failed = 1 if(/FAILED/i); END { exit($$failed) }'
...
$(addprefix $(output_dir)/, $(addsuffix .hex, $(rv64uzfh-p-asm-tests))): $(output_dir)/%.hex: $(RISCV)/riscv64-unknown-elf/share/riscv-tests/isa/%.hex
	mkdir -p $(output_dir)
	ln -fs $< $@

$(addprefix $(output_dir)/, $(rv64uzfh-p-asm-tests)): $(output_dir)/%: $(RISCV)/riscv64-unknown-elf/share/riscv-tests/isa/%
	mkdir -p $(output_dir)
	ln -fs $< $@

run-rv64uzfh-p-asm-tests: $(addprefix $(output_dir)/, $(addsuffix .out, $(rv64uzfh-p-asm-tests)))
	@echo; perl -ne 'print "  [$$1] $$ARGV \t$$2\n" if( /\*{3}(.{8})\*{3}(.*)/ || /ASSERTION (FAILED):(.*)/i )' $^ /dev/null | perl -pe 'BEGIN { $$failed = 0 } $$failed = 1 if(/FAILED/i); END { exit($$failed) }'

run-rv64uzfh-p-asm-tests-debug: $(addprefix $(output_dir)/, $(addsuffix .vpd, $(rv64uzfh-p-asm-tests)))
	@echo; perl -ne 'print "  [$$1] $$ARGV \t$$2\n" if( /\*{3}(.{8})\*{3}(.*)/ || /ASSERTION (FAILED):(.*)/i )' $(patsubst %.vpd,%.out,$^) /dev/null | perl -pe 'BEGIN { $$failed = 0 } $$failed = 1 if(/FAILED/i); END { exit($$failed) }'

run-rv64uzfh-p-asm-tests-fst: $(addprefix $(output_dir)/, $(addsuffix .fst, $(rv64uzfh-p-asm-tests)))
	@echo; perl -ne 'print "  [$$1] $$ARGV \t$$2\n" if( /\*{3}(.{8})\*{3}(.*)/ || /ASSERTION (FAILED):(.*)/i )' $(patsubst %.fst,%.out,$^) /dev/null | perl -pe 'BEGIN { $$failed = 0 } $$failed = 1 if(/FAILED/i); END { exit($$failed) }'
...
$(addprefix $(output_dir)/, $(addsuffix .hex, $(rv64uzbb-p-asm-tests))): $(output_dir)/%.hex: $(RISCV)/riscv64-unknown-elf/share/riscv-tests/isa/%.hex
	mkdir -p $(output_dir)
	ln -fs $< $@

$(addprefix $(output_dir)/, $(rv64uzbb-p-asm-tests)): $(output_dir)/%: $(RISCV)/riscv64-unknown-elf/share/riscv-tests/isa/%
	mkdir -p $(output_dir)
	ln -fs $< $@

run-rv64uzbb-p-asm-tests: $(addprefix $(output_dir)/, $(addsuffix .out, $(rv64uzbb-p-asm-tests)))
	@echo; perl -ne 'print "  [$$1] $$ARGV \t$$2\n" if( /\*{3}(.{8})\*{3}(.*)/ || /ASSERTION (FAILED):(.*)/i )' $^ /dev/null | perl -pe 'BEGIN { $$failed = 0 } $$failed = 1 if(/FAILED/i); END { exit($$failed) }'

run-rv64uzbb-p-asm-tests-debug: $(addprefix $(output_dir)/, $(addsuffix .vpd, $(rv64uzbb-p-asm-tests)))
	@echo; perl -ne 'print "  [$$1] $$ARGV \t$$2\n" if( /\*{3}(.{8})\*{3}(.*)/ || /ASSERTION (FAILED):(.*)/i )' $(patsubst %.vpd,%.out,$^) /dev/null | perl -pe 'BEGIN { $$failed = 0 } $$failed = 1 if(/FAILED/i); END { exit($$failed) }'

run-rv64uzbb-p-asm-tests-fst: $(addprefix $(output_dir)/, $(addsuffix .fst, $(rv64uzbb-p-asm-tests)))
	@echo; perl -ne 'print "  [$$1] $$ARGV \t$$2\n" if( /\*{3}(.{8})\*{3}(.*)/ || /ASSERTION (FAILED):(.*)/i )' $(patsubst %.fst,%.out,$^) /dev/null | perl -pe 'BEGIN { $$failed = 0 } $$failed = 1 if(/FAILED/i); END { exit($$failed) }'
...
run-asm-v-tests: $(addprefix $(output_dir)/, $(addsuffix .out, $(rv64ud-v-asm-tests) $(rv64ua-v-asm-tests) $(rv64uzba-v-asm-tests) $(rv64uzbs-v-asm-tests) $(rv64um-v-asm-tests) $(rv64uzbb-v-asm-tests) $(rv64uc-v-asm-tests) $(rv64uzfh-v-asm-tests) $(rv64uf-v-asm-tests) $(rv64ui-v-asm-tests)))
	@echo; perl -ne 'print "  [$$1] $$ARGV \t$$2\n" if( /\*{3}(.{8})\*{3}(.*)/ || /ASSERTION (FAILED):(.*)/i )' $^ /dev/null | perl -pe 'BEGIN { $$failed = 0 } $$failed = 1 if(/FAILED/i); END { exit($$failed) }'
run-asm-v-tests-debug: $(addprefix $(output_dir)/, $(addsuffix .vpd, $(rv64ud-v-asm-tests) $(rv64ua-v-asm-tests) $(rv64uzba-v-asm-tests) $(rv64uzbs-v-asm-tests) $(rv64um-v-asm-tests) $(rv64uzbb-v-asm-tests) $(rv64uc-v-asm-tests) $(rv64uzfh-v-asm-tests) $(rv64uf-v-asm-tests) $(rv64ui-v-asm-tests)))
	@echo; perl -ne 'print "  [$$1] $$ARGV \t$$2\n" if( /\*{3}(.{8})\*{3}(.*)/ || /ASSERTION (FAILED):(.*)/i )' $(patsubst %.vpd,%.out,$^) /dev/null | perl -pe 'BEGIN { $$failed = 0 } $$failed = 1 if(/FAILED/i); END { exit($$failed) }'
run-asm-v-tests-fst: $(addprefix $(output_dir)/, $(addsuffix .fst, $(rv64ud-v-asm-tests) $(rv64ua-v-asm-tests) $(rv64uzba-v-asm-tests) $(rv64uzbs-v-asm-tests) $(rv64um-v-asm-tests) $(rv64uzbb-v-asm-tests) $(rv64uc-v-asm-tests) $(rv64uzfh-v-asm-tests) $(rv64uf-v-asm-tests) $(rv64ui-v-asm-tests)))
	@echo; perl -ne 'print "  [$$1] $$ARGV \t$$2\n" if( /\*{3}(.{8})\*{3}(.*)/ || /ASSERTION (FAILED):(.*)/i )' $(patsubst %.fst,%.out,$^) /dev/null | perl -pe 'BEGIN { $$failed = 0 } $$failed = 1 if(/FAILED/i); END { exit($$failed) }'
run-asm-v-tests-fast: $(addprefix $(output_dir)/, $(addsuffix .run, $(rv64ud-v-asm-tests) $(rv64ua-v-asm-tests) $(rv64uzba-v-asm-tests) $(rv64uzbs-v-asm-tests) $(rv64um-v-asm-tests) $(rv64uzbb-v-asm-tests) $(rv64uc-v-asm-tests) $(rv64uzfh-v-asm-tests) $(rv64uf-v-asm-tests) $(rv64ui-v-asm-tests)))
	@echo; perl -ne 'print "  [$$1] $$ARGV \t$$2\n" if( /\*{3}(.{8})\*{3}(.*)/ || /ASSERTION (FAILED):(.*)/i )' $^ /dev/null | perl -pe 'BEGIN { $$failed = 0 } $$failed = 1 if(/FAILED/i); END { exit($$failed) }'


run-asm-p-tests: $(addprefix $(output_dir)/, $(addsuffix .out, $(rv64ui-p-asm-tests) $(rv64uzbs-p-asm-tests) $(rv64uzba-p-asm-tests) $(rv64ua-p-asm-tests) $(rv64ud-p-asm-tests) $(rv64um-p-asm-tests) $(rv64si-p-asm-tests) $(rv64uf-p-asm-tests) $(rv64uzfh-p-asm-tests) $(rv64uc-p-asm-tests) $(rv64uzbb-p-asm-tests) $(rv64mi-p-asm-tests)))
	@echo; perl -ne 'print "  [$$1] $$ARGV \t$$2\n" if( /\*{3}(.{8})\*{3}(.*)/ || /ASSERTION (FAILED):(.*)/i )' $^ /dev/null | perl -pe 'BEGIN { $$failed = 0 } $$failed = 1 if(/FAILED/i); END { exit($$failed) }'
run-asm-p-tests-debug: $(addprefix $(output_dir)/, $(addsuffix .vpd, $(rv64ui-p-asm-tests) $(rv64uzbs-p-asm-tests) $(rv64uzba-p-asm-tests) $(rv64ua-p-asm-tests) $(rv64ud-p-asm-tests) $(rv64um-p-asm-tests) $(rv64si-p-asm-tests) $(rv64uf-p-asm-tests) $(rv64uzfh-p-asm-tests) $(rv64uc-p-asm-tests) $(rv64uzbb-p-asm-tests) $(rv64mi-p-asm-tests)))
	@echo; perl -ne 'print "  [$$1] $$ARGV \t$$2\n" if( /\*{3}(.{8})\*{3}(.*)/ || /ASSERTION (FAILED):(.*)/i )' $(patsubst %.vpd,%.out,$^) /dev/null | perl -pe 'BEGIN { $$failed = 0 } $$failed = 1 if(/FAILED/i); END { exit($$failed) }'
run-asm-p-tests-fst: $(addprefix $(output_dir)/, $(addsuffix .fst, $(rv64ui-p-asm-tests) $(rv64uzbs-p-asm-tests) $(rv64uzba-p-asm-tests) $(rv64ua-p-asm-tests) $(rv64ud-p-asm-tests) $(rv64um-p-asm-tests) $(rv64si-p-asm-tests) $(rv64uf-p-asm-tests) $(rv64uzfh-p-asm-tests) $(rv64uc-p-asm-tests) $(rv64uzbb-p-asm-tests) $(rv64mi-p-asm-tests)))
	@echo; perl -ne 'print "  [$$1] $$ARGV \t$$2\n" if( /\*{3}(.{8})\*{3}(.*)/ || /ASSERTION (FAILED):(.*)/i )' $(patsubst %.fst,%.out,$^) /dev/null | perl -pe 'BEGIN { $$failed = 0 } $$failed = 1 if(/FAILED/i); END { exit($$failed) }'
run-asm-p-tests-fast: $(addprefix $(output_dir)/, $(addsuffix .run, $(rv64ui-p-asm-tests) $(rv64uzbs-p-asm-tests) $(rv64uzba-p-asm-tests) $(rv64ua-p-asm-tests) $(rv64ud-p-asm-tests) $(rv64um-p-asm-tests) $(rv64si-p-asm-tests) $(rv64uf-p-asm-tests) $(rv64uzfh-p-asm-tests) $(rv64uc-p-asm-tests) $(rv64uzbb-p-asm-tests) $(rv64mi-p-asm-tests)))
	@echo; perl -ne 'print "  [$$1] $$ARGV \t$$2\n" if( /\*{3}(.{8})\*{3}(.*)/ || /ASSERTION (FAILED):(.*)/i )' $^ /dev/null | perl -pe 'BEGIN { $$failed = 0 } $$failed = 1 if(/FAILED/i); END { exit($$failed) }'

run-asm-tests: $(addprefix $(output_dir)/, $(addsuffix .out, $(rv64ui-p-asm-tests) $(rv64uzbs-p-asm-tests) $(rv64uzba-p-asm-tests) $(rv64ua-p-asm-tests) $(rv64ud-p-asm-tests) $(rv64ud-v-asm-tests) $(rv64ua-v-asm-tests) $(rv64uzba-v-asm-tests) $(rv64uzbs-v-asm-tests) $(rv64um-p-asm-tests) $(rv64um-v-asm-tests) $(rv64si-p-asm-tests) $(rv64uzbb-v-asm-tests) $(rv64uc-v-asm-tests) $(rv64uzfh-v-asm-tests) $(rv64uf-v-asm-tests) $(rv64uf-p-asm-tests) $(rv64uzfh-p-asm-tests) $(rv64uc-p-asm-tests) $(rv64uzbb-p-asm-tests) $(rv64mi-p-asm-tests) $(rv64ui-v-asm-tests)))
	@echo; perl -ne 'print "  [$$1] $$ARGV \t$$2\n" if( /\*{3}(.{8})\*{3}(.*)/ || /ASSERTION (FAILED):(.*)/i )' $^ /dev/null | perl -pe 'BEGIN { $$failed = 0 } $$failed = 1 if(/FAILED/i); END { exit($$failed) }'
run-asm-tests-debug: $(addprefix $(output_dir)/, $(addsuffix .vpd, $(rv64ui-p-asm-tests) $(rv64uzbs-p-asm-tests) $(rv64uzba-p-asm-tests) $(rv64ua-p-asm-tests) $(rv64ud-p-asm-tests) $(rv64ud-v-asm-tests) $(rv64ua-v-asm-tests) $(rv64uzba-v-asm-tests) $(rv64uzbs-v-asm-tests) $(rv64um-p-asm-tests) $(rv64um-v-asm-tests) $(rv64si-p-asm-tests) $(rv64uzbb-v-asm-tests) $(rv64uc-v-asm-tests) $(rv64uzfh-v-asm-tests) $(rv64uf-v-asm-tests) $(rv64uf-p-asm-tests) $(rv64uzfh-p-asm-tests) $(rv64uc-p-asm-tests) $(rv64uzbb-p-asm-tests) $(rv64mi-p-asm-tests) $(rv64ui-v-asm-tests)))
	@echo; perl -ne 'print "  [$$1] $$ARGV \t$$2\n" if( /\*{3}(.{8})\*{3}(.*)/ || /ASSERTION (FAILED):(.*)/i )' $(patsubst %.vpd,%.out,$^) /dev/null | perl -pe 'BEGIN { $$failed = 0 } $$failed = 1 if(/FAILED/i); END { exit($$failed) }'
run-asm-tests-fst: $(addprefix $(output_dir)/, $(addsuffix .fst, $(rv64ui-p-asm-tests) $(rv64uzbs-p-asm-tests) $(rv64uzba-p-asm-tests) $(rv64ua-p-asm-tests) $(rv64ud-p-asm-tests) $(rv64ud-v-asm-tests) $(rv64ua-v-asm-tests) $(rv64uzba-v-asm-tests) $(rv64uzbs-v-asm-tests) $(rv64um-p-asm-tests) $(rv64um-v-asm-tests) $(rv64si-p-asm-tests) $(rv64uzbb-v-asm-tests) $(rv64uc-v-asm-tests) $(rv64uzfh-v-asm-tests) $(rv64uf-v-asm-tests) $(rv64uf-p-asm-tests) $(rv64uzfh-p-asm-tests) $(rv64uc-p-asm-tests) $(rv64uzbb-p-asm-tests) $(rv64mi-p-asm-tests) $(rv64ui-v-asm-tests)))
	@echo; perl -ne 'print "  [$$1] $$ARGV \t$$2\n" if( /\*{3}(.{8})\*{3}(.*)/ || /ASSERTION (FAILED):(.*)/i )' $(patsubst %.fst,%.out,$^) /dev/null | perl -pe 'BEGIN { $$failed = 0 } $$failed = 1 if(/FAILED/i); END { exit($$failed) }'
run-asm-tests-fast: $(addprefix $(output_dir)/, $(addsuffix .run, $(rv64ui-p-asm-tests) $(rv64uzbs-p-asm-tests) $(rv64uzba-p-asm-tests) $(rv64ua-p-asm-tests) $(rv64ud-p-asm-tests) $(rv64ud-v-asm-tests) $(rv64ua-v-asm-tests) $(rv64uzba-v-asm-tests) $(rv64uzbs-v-asm-tests) $(rv64um-p-asm-tests) $(rv64um-v-asm-tests) $(rv64si-p-asm-tests) $(rv64uzbb-v-asm-tests) $(rv64uc-v-asm-tests) $(rv64uzfh-v-asm-tests) $(rv64uf-v-asm-tests) $(rv64uf-p-asm-tests) $(rv64uzfh-p-asm-tests) $(rv64uc-p-asm-tests) $(rv64uzbb-p-asm-tests) $(rv64mi-p-asm-tests) $(rv64ui-v-asm-tests)))
	@echo; perl -ne 'print "  [$$1] $$ARGV \t$$2\n" if( /\*{3}(.{8})\*{3}(.*)/ || /ASSERTION (FAILED):(.*)/i )' $^ /dev/null | perl -pe 'BEGIN { $$failed = 0 } $$failed = 1 if(/FAILED/i); END { exit($$failed) }'
